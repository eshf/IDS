...
/**
 * Module: CSCI262 Assignment 3
 * Members: 
 * 		Shu Hui Fiona Eng (5279148)
 * 		William Tay Teck Shuo (6662171)
 * 		Lan Yung Lee (6744369)
 *
 */
    ...
    public EventType[] processLogs(int days, String prefix) throws FileNotFoundException
    {
        ...
        
        {
            ...
            for(int j=0;j<eventStats.length;j++)
            {
                ...
                System.out.println(eventStats[j].getName()+" generator stats: "+eventStats[j].getMean()+" "+eventStats[j].getStd()+" calculated stats: "+mean+" "+std);
				
				
			    //Continuous
				//This line of code is to get the upper quartile as mean is the middle of the curve and plus one standard deviation would get the stats for upper limit
				int highest = (int) (mean + std);
				
				
				//This line of code is to get the lower quartile as mean is the middle of the curve and minus one standard deviation would get the stats for lower limit:
